...
export const isKeyword = makePredicate("break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this let const class extends export import yield super トッピング あり ぬき 丼 店 退店 新店舗 ニンニク入れますか ニンニク ヤサイ アブラ カラメ そのままで 完食");
