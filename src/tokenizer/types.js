...
export const keywords = {
  ...
  "ニンニク": new KeywordTokenType("case", { beforeExpr }),
  "ヤサイ": new KeywordTokenType("case", { beforeExpr }),
  "アブラ": new KeywordTokenType("case", { beforeExpr }),
  "カラメ": new KeywordTokenType("case", { beforeExpr }),
  "catch": new KeywordTokenType("catch"),
  "continue": new KeywordTokenType("continue"),
  "debugger": new KeywordTokenType("debugger"),
  "default": new KeywordTokenType("default", { beforeExpr }),
  "そのままで": new KeywordTokenType("default", { beforeExpr }),
  ...
  "あり": new KeywordTokenType("true", { startsExpr }),
  "false": new KeywordTokenType("false", { startsExpr }),
  "ぬき": new KeywordTokenType("false", { startsExpr }),
